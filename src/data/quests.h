...
static const struct SideQuestEvent sSideQuestEvents_2[] = {event(gText_SideQuestDesc_2_1, PICTYPE_OBJECT_EVENT, OBJ_EVENT_GFX_EXPERT_F),
                                                           event(gText_SideQuestDesc_2_2, PICTYPE_PARTY_ICON, SPECIES_EGG)};
...
static const struct SideQuestEvent sSideQuestEvents_5[] = {event(gText_SideQuestDesc_5_1, PICTYPE_ITEM_ICON, ITEM_DIANCITE),
                                                           event(gText_SideQuestDesc_5_2, PICTYPE_ITEM_ICON, ITEM_HELIX_FOSSIL),
                                                           event(gText_SideQuestDesc_5_3, PICTYPE_ITEM_ICON, ITEM_OLD_SEA_MAP)};
