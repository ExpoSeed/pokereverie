...
#define QUEST_MENU_GET_STATE            3   //Returns the state of questId to gSpecialVar_Result
#define QUEST_MENU_INCREMENT_STATE      4   //increments the state of questId by 1
