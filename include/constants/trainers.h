...
#define F_TRAINER_PARTY_SCALED_BY_LEVEL (1 << 3)
#define F_TRAINER_PARTY_SCALED_BY_BADGE (1 << 4)

#define F_TRAINER_PARTY_SCALED (F_TRAINER_PARTY_SCALED_BY_LEVEL | F_TRAINER_PARTY_SCALED_BY_BADGE)
