...
struct SideQuestProgress
{
    u8 progress:7;
    u8 completed:1;
    u8 eventList[MAX_EVENT_COUNT];
};
...
struct SaveBlock2
{
    ...
    /*0x0F2C*/ struct SideQuestProgress quests[SIDE_QUEST_COUNT];
...
struct SaveBlock1
{
    ...
    /*0x27CA*/ u8 padding_27CA[1];
    /*0x27CB*/ u8 scaledLevel;
